...
# 1. 1번집의 색은 2번집의 색과 같지 않아야한다.
# 2. N번 집의 색은 N-1번 집의 색과 같지 않아야 한다.
# 3. i(2<=i<=N-1)번 집의 색은 i-1번, i+1번 집의 색과 같지 않아야 한다.

# 입력 : 첫재 줄에 집의 수 N(2<=N<=1,000)이 주어진다. 둘째 줄 부터 N개의 줄에는 각 집을 빨강,초록,파랑으로 칠하는 비용이 1번 집부터 한 줄에 하나씩 주어진다.
#        집을 칠하는 비용은 1000보다 작거나 같은 자연수 이다.
